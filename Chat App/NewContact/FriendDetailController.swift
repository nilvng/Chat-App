...
class FriendDetailViewController: UIViewController {
    ...
    typealias FriendChangeAction = (FriendContact) -> Void
    
    private var changeAction : FriendChangeAction?
    
    private var friend : FriendContact?
    private var tempFriend : FriendContact?
    ...
    func configure(with friend: FriendContact,
                   isNew : Bool = false,
...
//        tableView.register(UITableViewCell.self, forCellReuseIdentifier: FriendDetailDataSource.identifier)
    ...
    fileprivate func transitionToDetailMode(_ friend : FriendContact){
    ...
    fileprivate func transitionToEditMode(_ friend: FriendContact){
